...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        UINavigationBar.appearance().largeContentTitle = NavigationProperties.largeContentTitle
        ...
        let tabItemMovies = UITabBarItem(title: TabbarProperties.title, image: UIImage(named: TabbarProperties.image), tag: 0)
